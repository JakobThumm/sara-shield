...
class HumanReach {
  ...
  */
   ...
   */
  std::vector<std::vector<std::vector<reach_lib::Capsule>>> improvedHumanReachabilityAnalysis(double t_command, double current_motion_time, double goal_motion_time, double sample_time);
