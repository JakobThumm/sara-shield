 ...
 */
class RvizMarker {
  enum { ROBOT = 0u, HUMAN_CYLINDER = 1u, HUMAN_REACH = 2u };
 ...
 private:
   ...
   */
  void createCapsules(visualization_msgs::MarkerArray& markers, const custom_robot_msgs::CapsuleArray* capsules);
   ...
   */
  void createSphere(const geometry_msgs::Point& pos, double radius, const ros::Time& stamp,
   ...
   * @param[in] marker           The marker to update
   */
  void createCylinder(const custom_robot_msgs::Segment& seg, double radius, const ros::Time& stamp,
                      visualization_msgs::Marker& marker);
 ...
 public:
   ...
   */
  RvizMarker(ros::Publisher robot_visu_pub, ros::Publisher human_cylinder_visu_pub,
             ros::Publisher human_reach_visu_pub_P, ros::Publisher human_reach_visu_pub_V,
