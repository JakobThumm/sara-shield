...
PYBIND11_MODULE(safety_shield_py, handle) {
  ...
  py::class_<safety_shield::SafetyShield>(handle, "SafetyShield")
    ...
    .def("getRobotReachPFLCapsules", &safety_shield::SafetyShield::getRobotReachPFLCapsules)
    .def("getHumanReachPFLCapsules", &safety_shield::SafetyShield::getHumanReachPFLCapsules, py::arg("type") = 1)
